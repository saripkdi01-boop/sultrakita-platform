(function (global) {
  const CATEGORIES = [
    { id: 1, slug: 'kendaraan', name: 'Kendaraan', icon: '🚗' }, { id: 2, slug: 'properti', name: 'Properti & Sewa', icon: '🏠' },
    { id: 3, slug: 'elektronik', name: 'Elektronik', icon: '📱' }, { id: 4, slug: 'hobi', name: 'Hobi & Olahraga', icon: '🎣' },
    { id: 5, slug: 'rumah-tangga', name: 'Perabot Rumah', icon: '🛋️' }, { id: 6, slug: 'fashion', name: 'Fashion & Aksesori', icon: '👗' },
    { id: 7, slug: 'kuliner', name: 'Kuliner & Bahan Pangan', icon: '🍲' }, { id: 8, slug: 'hasil-laut', name: 'Hasil Laut & Perikanan', icon: '🐟' },
    { id: 9, slug: 'pertanian', name: 'Pertanian & Perkebunan', icon: '🌾' }, { id: 10, slug: 'jasa', name: 'Jasa & Tukang', icon: '🛠️' },
    { id: 11, slug: 'lowongan', name: 'Lowongan Kerja', icon: '💼' }, { id: 12, slug: 'gratis', name: 'Gratis / Berbagi', icon: '🎁' }
  ];
  const REGIONS = [
    ...
    { slug: 'baubau', name: 'Kota Baubau', districts: ['Betoambari', 'Murhum', 'Wolio', 'Kokalukuna', 'Soraworio', 'Bungi', 'Lea-Lea', 'Batupoaro'] },
  ...
  global.SultraTaxonomy = { CATEGORIES, REGIONS, ALL_DISTRICTS: [...new Set(REGIONS.flatMap(region => region.districts))] };
}(window));
