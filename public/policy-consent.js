(() => {
  const POLICY_VERSION = '2026-09-17-v1';
  ...
  const ensureModal = () => {
    ...
    dialog.innerHTML = `<form method="dialog" class="policy-consent-card"><div class="policy-consent-head"><div><span class="eyebrow">Sebelum melanjutkan</span><h2>Ruang Suki Apps yang aman dimulai dari transparansi.</h2><p>Persetujuan ini membantu kami mengelola akun, cerita, listing, pesan, dan transaksi secara bertanggung jawab.</p></div><button class="dialog-close" value="cancel" aria-label="Tutup">×</button></div><div class="policy-consent-links"><a href="/terms.html" target="_blank" rel="noopener">Baca Terms of Service <span>↗</span></a><a href="/privacy.html" target="_blank" rel="noopener">Baca Privacy Policy <span>↗</span></a></div><label class="policy-check"><input id="policy-terms-check" type="checkbox"><span>Saya telah membaca dan menyetujui <a href="/terms.html" target="_blank" rel="noopener">Terms of Service</a>.</span></label><label class="policy-check"><input id="policy-privacy-check" type="checkbox"><span>Saya memahami <a href="/privacy.html" target="_blank" rel="noopener">Privacy Policy</a> dan pemrosesan data yang dijelaskan di dalamnya.</span></label><p class="policy-consent-note">Versi kebijakan: ${POLICY_VERSION}. Permintaan akses, koreksi, atau penghapusan data dapat dikirim ke SultrakitaPlatform@gmail.com.</p><div class="policy-consent-actions"><button class="button button-quiet" value="cancel">Nanti</button><button class="button button-primary" id="policy-consent-accept" value="accept" disabled>Saya setuju & lanjut</button></div></form>`;
