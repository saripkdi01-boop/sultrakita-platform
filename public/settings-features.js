...
window.SULTRAKITA_SETTINGS_FEATURES = [
  ...
  {id:'account-activity',group:'Aktivitas',title:'Aktivitas akun',description:'Ringkasan aktivitas akun',iconKey:'security',route:'/settings.html#keamanan',api:'/api/settings/activity',authRequired:true,status:'active'},
  ...
  {id:'app-icon',group:'Tampilan',title:'Ikon aplikasi',description:'Pilihan ikon SultraKita',iconKey:'app',route:'/settings.html#preferensi',api:'/api/settings/preferences',authRequired:true,status:'active'},
  {id:'blocking',group:'Lainnya',title:'Pemblokiran',description:'Belum ada model block-list di backend',iconKey:'block',route:'/settings.html#pemblokiran',api:'/api/settings/blocks',authRequired:true,status:'active'},
