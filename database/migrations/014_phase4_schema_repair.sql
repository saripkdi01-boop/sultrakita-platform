-- Additive production repair for databases that predate the Phase 4 migration set.
-- Every operation is safe to rerun and preserves existing rows and tables.
