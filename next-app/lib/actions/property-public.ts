...
const demoProperties = {
  'demo-1': { id: 'demo-1', category: 'rumah_second', title: 'Rumah Modern Dekat Pusat Kendari', description: 'Contoh listing untuk pratinjau alur properti publik.', price: 45000000, price_type: 'per_tahun', district: 'Kambu', city: 'Kendari', bedrooms: 3, bathrooms: 2, building_area_sqm: 120, is_featured: true, is_demo: true, views_count: 128, favorites_count: 12 },
