...
const tools = [{ label: 'Buat listing baru', description: 'Jual produk atau jasa lokal', Icon: Plus, href: '#create' }, { label: 'Kelola listing', description: 'Edit dan atur status produk', Icon: ClipboardList, href: '/dashboard/properties' }, { label: 'Foto produk', description: 'Panduan foto yang menjual', Icon: ImagePlus, href: '#photo-guide' }, { label: 'Pengaturan toko', description: 'Atur profil dan preferensi', Icon: Settings2, href: '/marketplace/profile' }];
