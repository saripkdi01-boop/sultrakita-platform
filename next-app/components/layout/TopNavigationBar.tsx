...
export function TopNavigationBar({ userName = 'Pengguna', avatarUrl, notificationCount = 0, messageCount = 0, onCreate, onSearch, onChat, onNotifications }: TopNavigationBarProps) {
