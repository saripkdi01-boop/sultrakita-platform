...
import { BriefcaseBusiness, Building2, Home, Store, Users, Video } from 'lucide-react';
...
const items: Array<{ key: QuickNavKey; label: string; Icon: typeof Home; badge?: string }> = [
  { key: 'home', label: 'Beranda', Icon: Home }, { key: 'reels', label: 'Reels', Icon: Video }, { key: 'groups', label: 'Komunitas', Icon: Users }, { key: 'market', label: 'SUKI Jobs', Icon: BriefcaseBusiness, badge: 'NEW' }, { key: 'suits', label: 'SUKI Suits', Icon: Building2, badge: 'NEW' }, { key: 'marketplace', label: 'SUKI Marketplace', Icon: Store },
];
