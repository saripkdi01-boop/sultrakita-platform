...
const items: Array<{ key: QuickNavKey; label: string; Icon: typeof Home }> = [
  { key: 'home', label: 'Beranda', Icon: Home }, { key: 'reels', label: 'Reels', Icon: Video }, { key: 'groups', label: 'Komunitas', Icon: Users }, { key: 'market', label: 'Marketplace', Icon: Store }, { key: 'suits', label: 'SUKI Suits', Icon: MessageCircle }, { key: 'marketplace', label: 'SUKI Marketplace', Icon: Menu },
];
