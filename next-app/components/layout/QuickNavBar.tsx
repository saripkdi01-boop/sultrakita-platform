...
const items: Array<{ key: QuickNavKey; label: string; Icon: typeof Home }> = [
  { key: 'home', label: 'Beranda', Icon: Home }, { key: 'reels', label: 'Reels', Icon: Video }, { key: 'groups', label: 'Komunitas', Icon: Users }, { key: 'market', label: 'Marketplace', Icon: ShoppingBag }, { key: 'suits', label: 'SUKI Suits', Icon: Building2 }, { key: 'marketplace', label: 'SUKI Marketplace', Icon: Store },
];
