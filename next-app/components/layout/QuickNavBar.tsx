...
import { Home, Menu, MessageCircle, Store, Users, Video } from 'lucide-react';

type QuickNavKey = 'home' | 'reels' | 'groups' | 'market' | 'chat' | 'menu';
...
const items: Array<{ key: QuickNavKey; label: string; Icon: typeof Home }> = [
  { key: 'home', label: 'Beranda', Icon: Home }, { key: 'reels', label: 'Reels', Icon: Video }, { key: 'groups', label: 'Komunitas', Icon: Users }, { key: 'market', label: 'Marketplace', Icon: Store }, { key: 'chat', label: 'SUKI Chat', Icon: MessageCircle }, { key: 'menu', label: 'Menu', Icon: Menu },
];
