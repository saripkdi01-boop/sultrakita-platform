...
export function SidebarDesktop() {
  ...
  return <aside className={`desktop-sidebar ${collapsed ? 'collapsed' : ''}`}>
    <div className="sidebar-inner">
      ...
      {!collapsed && <div className="sidebar-footer"><a className="side-upgrade" href="#premium"><Crown size={16} /><span><strong>{labels.premium}</strong><small>Bangun eksistensi publik</small></span></a><div className="side-login"><LogOut size={16} /><span>{labels.logout}</span></div><small>© 2026 SUKI Suits</small></div>}
