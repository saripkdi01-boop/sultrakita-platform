...
import { ChevronDown, ChevronLeft, ChevronRight, Crown, LogOut, RefreshCw, Languages, Megaphone, Moon, Sun, UserRound, BadgeCheck } from 'lucide-react';
...
export function SidebarDesktop() {
  ...
  return <aside className={`desktop-sidebar ${collapsed ? 'collapsed' : ''}`} aria-label="Sidebar SUKI Platforms">
    <div className="sidebar-inner">
      ...
      <Link className="sidebar-campaign-link" href="/campaigns"><Megaphone size={16} /><span><strong>Campaign Hub</strong><small>Campaign ekosistem SUKI</small></span></Link>
